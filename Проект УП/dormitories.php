...
$query = "SELECT * FROM Dormitories WHERE 1=1";
...
if (!empty($roomNumber)) {
    $query .= " AND RoomNumber = '$roomNumber'";
}

if (!empty($checkInDate)) {
    $query .= " AND CheckInDate = '$checkInDate'";
}

if (!empty($checkOutDate)) {
    $query .= " AND CheckOutDate = '$checkOutDate'";
}
...
<body>
    ...
    <main>
        <section>
            <h2>Список студентов в общежитии</h2>
            <form method="get" action="dormitories.php">
                ...
                <input type="text" id="roomNumber" name="roomNumber" placeholder="Введите номер комнаты" value="<?php echo htmlspecialchars($roomNumber); ?>">

                <label for="checkInDate">Дата заселения:</label>
                <input type="date" id="checkInDate" name="checkInDate" value="<?php echo htmlspecialchars($checkInDate); ?>">

                <label for="checkOutDate">Дата выселения:</label>
                <input type="date" id="checkOutDate" name="checkOutDate" value="<?php echo htmlspecialchars($checkOutDate); ?>">
            ...
            <table>
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "<tr><td colspan='5'>Нет данных о студентах в общежитии</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
